...
Source0: https://ftp.postgresql.org/pub/source/v%{version}/postgresql-%{version_beta}.tar.bz2
# The PDF file is generated by generate-pdf.sh, which see for comments
Source1: postgresql-%{version_beta}-US.pdf
...
Source16: https://ftp.postgresql.org/pub/source/v%{version}/postgresql-%{version_beta}.tar.bz2.sha256
...
%setup -q %{?scl:-n %{pkg_name}-%{version_beta}} -a 12
%patch1 -p1
%patch2 -p1
...
find_lang_bins libs.lst ecpglib%{?scl_prefix}7 libpq%{?scl_prefix}5
