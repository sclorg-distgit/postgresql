...
# see bz#1009365
sed -i	-e 's|/var/lib/pgsql/data|%{?_localstatedir}/lib/pgsql/data|' postgresql-bashprofile
...
* Thu Feb 11 2016 Honza Horak <hhorak@redhat.com> - 9.5.0-5
